...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ ('Register Club') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('requestform.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <label for="exampleFormControlTextarea1" style="position: absolute;" class="col-md-4 col-form-label text-md-right">Example textarea</label>
